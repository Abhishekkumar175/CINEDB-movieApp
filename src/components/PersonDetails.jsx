...
const PersonDetails = () => {
  document.title = "CINEDB | Person Details";
  ...
  return info ? (
    <div className="px-[10%] w-screen h-[160vh] bg-[#1F1E24]">
      {/* Part 1 navigation */}
      ...
      <div className="w-full flex">
          ...
          <img
            ...
            src={
              info.detail.profile_path
                ...
                : "fallback-image.jpg" // Add a fallback image URL here
            }
        ...
        <div className="w-[80%] ml-[5%]">
          ...
          <div className="px-[10%] w-[80%] h-[32%]  bg-[#f33131] ">
            <h2 className="text-zinc-200 p-6 text-4xl">
              Sorry, we couldn't load the celebrity details due to an issue with
