...
const TvDetails = () => {
    document.title = "CINEDB | Tv Show Details";
    ...
    return info ? (
        ...
        >
            ...
            <nav className="h-[10vh] w-full text-zinc-100 flex items-center gap-10 text-xl ">
                <Link
                    onClick={() => navigate(-1)}
                    className="hover:text-[#961D7F] ri-arrow-left-line"
                ></Link>
                ...
                >
                    <img className="w-14 h-6" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-V6QuTrVSv3yax4jL-6oPslvpzbN1uNajYw&s" />
                </a>
                ...
                >
                    <img className="w-14 h-15" src="https://cdn-icons-png.flaticon.com/512/5977/5977585.png" />
                </a>
            </nav>
            ...
            <div className="w-full flex">
                ...
                <div className="content ml-[5%]  text-white">
                    ...
                    <div className="mt-2 mb-3 flex  items-center gap-x-3">
                    ...
                    <h1 className="text-2xl mb-2 mt-3">Overview</h1>
                    <p>{info.detail.overview}</p>

                    <h1 className="text-2xl mb-2  mt-3">tv Translated</h1>
                    <p className="mb-10">{info.translations.join(", ")}</p>

                    <Link
                        className="p-3 bg-[#961D7F] rounded-lg"
                        to={`${pathname}/trailer`}
                    >
            ...
            <div className="w-[80%] flex flex-col gap-y-5 mt-6">
            ...
            <div className="w-[100%] flex overflow-y-hidden mb-3 p-3  ">
                {info.detail.seasons.length > 0 ? (
                    info.detail.seasons.map((s, i) => (
                        <div key={i} className="w-[15vh] mr-[12%] h-[34vh]">
                            <img
